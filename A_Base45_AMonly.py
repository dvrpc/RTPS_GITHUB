...
runDir = r"D:\BikePedTransit\RTPS\ServiceAccessibility\Accessible_Connectors\Base_NoBus\DeletedSA"
TODs = ["AM", "MD", "PM", "NT"]
...
with open(r'D:\BikePedTransit\RTPS\ServiceAccessibility\Base_NoBus_60minRIT_AM.csv','wb') as IO:
    w = csv.writer(IO)
...
with open(r'D:\BikePedTransit\RTPS\ServiceAccessibility\Base_NoBus_60minRIT_AM_NoDataZones.csv','wb') as IO:
    w = csv.writer(IO)    
