...
with open(r'D:\BikePedTransit\RTPS\ServiceAccessibility\Base_NoBus_binary_delSA_AM.csv','wb') as IO:
    w = csv.writer(IO)
    ...
    for i in xrange(0,len(AVG_RIT_NoWeight)):
        ...
        for j in xrange(0, len(AVG_RIT_NoWeight[i])):
            ...
            if AVG_RIT_NoWeight[i][j]<999999:
...
with open(r'D:\BikePedTransit\RTPS\ServiceAccessibility\Base_NoBus_binary_delSA_NoDataZones_AM.csv','wb') as IO:
    w = csv.writer(IO)    
